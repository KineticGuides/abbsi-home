...
@Component({
  selector: 'app-upload-labs',
  standalone: true,
  imports: [],
  templateUrl: './upload-labs.component.html',
  styleUrl: './upload-labs.component.css'
})
export class UploadLabsComponent  implements OnInit, AfterViewInit {
