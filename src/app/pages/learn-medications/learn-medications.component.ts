...
@Component({
  selector: 'app-learn-medications',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './learn-medications.component.html',
  styleUrl: './learn-medications.component.css'
})
export class LearnMedicationsComponent  implements OnInit {
