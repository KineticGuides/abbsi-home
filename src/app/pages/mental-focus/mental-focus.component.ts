...
@Component({
  selector: 'app-mental-focus',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './mental-focus.component.html',
  styleUrl: './mental-focus.component.css'
})
export class MentalFocusComponent  implements OnInit {
