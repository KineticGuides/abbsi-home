...
@Component({
  selector: 'app-learn-viseral-fat',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './learn-viseral-fat.component.html',
  styleUrl: './learn-viseral-fat.component.css'
})
export class LearnViseralFatComponent  implements OnInit {
