...
@Component({
  selector: 'app-stress-levels',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './stress-levels.component.html',
  styleUrl: './stress-levels.component.css'
})
export class StressLevelsComponent  implements OnInit {
