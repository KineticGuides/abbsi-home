...
@Component({
  selector: 'app-sexual-function',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './sexual-function.component.html',
  styleUrl: './sexual-function.component.css'
})
export class SexualFunctionComponent  implements OnInit {
