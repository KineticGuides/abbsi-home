...
@Component({
  selector: 'app-learn-healthy-living',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './learn-healthy-living.component.html',
  styleUrl: './learn-healthy-living.component.css'
})
export class LearnHealthyLivingComponent  implements OnInit {
