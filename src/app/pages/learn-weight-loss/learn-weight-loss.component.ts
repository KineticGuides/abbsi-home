...
@Component({
  selector: 'app-learn-weight-loss',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './learn-weight-loss.component.html',
  styleUrl: './learn-weight-loss.component.css'
})
export class LearnWeightLossComponent  implements OnInit {
