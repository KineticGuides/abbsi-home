...
@Component({
  selector: 'app-learn-supplements',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './learn-supplements.component.html',
  styleUrl: './learn-supplements.component.css'
})
export class LearnSupplementsComponent  implements OnInit {
